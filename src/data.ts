...
export const EXPERIENCES: Experience[] = [
  {
    ...
    period: "2023 - Present",
    description:
      "Developing modern, responsive web applications with React and Node.js. Focused on performance and modularity.",
  ...
  },
  {
    ...
    period: "2022 - 2023",
    description:
      "Engineered backend systems using Laravel and integrated with custom frontend components.",
  ...
  },
  {
    ...
    period: "2021 - 2022",
    description:
      "Built interactive landing pages and optimized SEO performance for client projects.",
